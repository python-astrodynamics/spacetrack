...
RELEASE = Version.parse(dist.version)
# Truncate release to x.y
VERSION = Version(release=RELEASE.release[:2])
...
latex_documents = [
    ('index', 'spacetrack.tex', 'spacetrack Documentation', AUTHOR, 'manual'),
]
...
man_pages = [
    ('index', 'spacetrack', 'spacetrack Documentation',
     [AUTHOR], 1)
]
...
texinfo_documents = [
    ('index', 'spacetrack', 'spacetrack Documentation', AUTHOR, 'spacetrack',
